...
<div class="collapse" id="navbarToggleExternalContent">
  <div class="bg-dark p-4">
    ...
    <a href="index.php" class="text-white h5 bg-dark list-group-item list-group-item-action active" aria-current="true">
    ...
    <a href="insumos.php" class="text-white h5 bg-dark list-group-item list-group-item-action">Solicitud de insumos</a>    
  </div>
</div>
